...
const About = () => {
  return (
    <main className={``}>
      ...
      <HeaderPage />
      <NavNavigation />
      <div className={`mx-auto block w-[300px] lg:w-[900px] pt-[50px]`}>
        <div
          className={`flex-col flex items-center lg:flex lg:justify-center lg:flex-row lg:items-baseline lg:space-x-[50px]`}
        >
          <div className={`text-[20px]`}>
            Welcome to Global News: Your Window to the World. Our mission is to
            provide our audience with immediate access to real-time events and
            in-depth analysis from around the world. We are dedicated to
            delivering accurate, comprehensive news coverage that connects you
            to the stories shaping our globe. With correspondents in every
            corner of the world, Global News ensures you are always informed and
            engaged with the events that matter most. Stay informed, stay
            connected, with Global News.
          </div>
          <div>
            <div className={`uppercase`}>our social</div>
            <div>
